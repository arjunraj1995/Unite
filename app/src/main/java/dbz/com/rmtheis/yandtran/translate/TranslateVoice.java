 ...
 */
package dbz.com.rmtheis.yandtran.translate;

import java.net.URL;
import java.net.URLEncoder;

import dbz.com.rmtheis.yandtran.ApiKeys;
import dbz.com.rmtheis.yandtran.YandexTranslatorAPI;
import dbz.com.unite.LanguageVoice;

/**
 * Makes calls to the Yandex machine translation web service API
 */
public final class TranslateVoice extends YandexTranslatorAPI {
     ...
     */
    public static String execute(final String text, final LanguageVoice from, final LanguageVoice to) throws Exception {
